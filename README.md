...
- `document-classifier_safe.eide` — the correct design.
- `document-classifier_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
